/* ==========================================================================
HÜCUM (SQL INJECTION) ÜÇÜN TƏLİMAT:
1. Kodun içində "HÜCUM ÜÇÜN BURANI AÇ" yazılan hissəni tap.
2. Təhlükəsiz olan (const query = '... $1') sətrini şərhə al (// qoy).
3. Təhlükəli olan (const query = `... ${username}`) sətrinin şərhini sil.
4. Şifrə bypassı üçün "if (isMatch || ...)" olan hissəni aktivləşdir.

HÜCUM KODLARI (Payloads):
- Login Bypass: ' OR '1'='1' --
- Cədvəli Silmək: '; DROP TABLE orders; --
- Versiyanı Öyrənmək: ' UNION SELECT NULL, version(), NULL --
==========================================================================
*/
